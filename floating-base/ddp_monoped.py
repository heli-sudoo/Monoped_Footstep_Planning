...
Horizon = len(Traj)
smtSol.plot_solution(Traj, dt_coarse, filename="smt_monoped.gif", save=True)
...
ddp = crocoddyl.SolverFDDP(problem) # other options SolverDDP
...
smtSol.plot_solution(Traj_ddp, dt_fine, filename="ddp_monoped.gif", save=True)
